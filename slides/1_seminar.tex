...
\section{Hvad er regularitet og Automater}
\begin{frame}
...
\item $r_1 + r_2$ matcher hvis $r_1$ matcher, eller $r_2$ matcher
...
\begin{frame}
\frametitle{Hvorfor så nøjes med regulære sprog}
\begin{itemize}
...
\frametitle{Eksamen}
\begin{itemize}
\item Mundtlig, ekstern censur, 7-skalaen
...
\section{Skelnelighed, produktkonstruktion}
