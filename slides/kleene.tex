...
\item
\visible<2->{\includegraphics[scale=0.4]{images/2_seminar_basis_lambda}}
\item
\visible<3->{\includegraphics[scale=0.4]{images/2_seminar_basis_a}}
\end{itemize}
\end{columns}
\end{frame}
\begin{frame}
...
\begin{columns}
\column{5cm}\visible<2->{$r=r_1+r_2$}
\column{5cm}\visible<2->{\includegraphics[scale=0.4]{images/2_seminar_kleene_1_add}}
\end{columns}
\end{frame}
...
\item $r=r_1\cdot r_2$ \\
\begin{center}
\visible<2->{\includegraphics[scale=0.4]{images/2_seminar_kleene_1_times}}
\end{center}
\item \onslide<3->{$r=r_1^*$} \\
\begin{center}
\visible<4->{\includegraphics[scale=0.4]{images/2_seminar_kleene_1_star}}
\end{center}
\end{itemize}
\end{frame}
...
\begin{frame}
\frametitle{Eksempel (1/3)}
Konstruer en NFA-$\Lambda$ for det regulære udtryk $(00+1)^*(10)^*$
\begin{itemize}
\item 0:
\visible<2->{\includegraphics[scale=0.4]{images/2_seminar_kleene_1_ex_0}}
\item 1:
  \visible<3->{\includegraphics[scale=0.4]{images/2_seminar_kleene_1_ex_1}}
\item 00:
  \visible<4->{\includegraphics[scale=0.4]{images/2_seminar_kleene_1_ex_00}}
\item 10:
  \visible<5->{\includegraphics[scale=0.4]{images/2_seminar_kleene_1_ex_10}}
\end{itemize}
\end{frame}
...
\item $00+1$:
\begin{center}
 \visible<2->{\includegraphics[scale=0.4]{images/2_seminar_kleene_1_ex_00plus1}}
\end{center}
\item $(00+1)^*$:
\begin{center}
 \visible<3->{\includegraphics[scale=0.4]{images/2_seminar_kleene_1_ex_00plus1star}}
\end{center}
\end{itemize}
\end{frame}
...
\item $(10)^*$:\\
\begin{center}
 \visible<2->{\includegraphics[scale=0.4]{images/2_seminar_kleene_1_ex_10star}}
\end{center}
\item $(00+1)^*(10)^*$: \\
\begin{center}
  \visible<3->{\includegraphics[scale=0.4]{images/2_seminar_kleene_1_ex_00plus1star10star}}
\end{center}
\end{itemize}
\end{frame}
...
\item Definer $L(p, q, k)$ hvor $p,q\in Q$ og $k\in \{1..|Q|\}$ som: \\
  ...
  \visible<2->{\includegraphics[scale=0.2]{images/2_seminar_kleene_2_lessk}}
